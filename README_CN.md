...
[![Go Report Card](https://goreportcard.com/badge/github.com/temukan-co/monolith)](https://goreportcard.com/report/github.com/temukan-co/monolith)
[![License](https://img.shields.io/github/license/evrone/go-clean-template.svg)](https://github.com/temukan-co/monolith/blob/master/LICENSE)
[![Release](https://img.shields.io/github/v/release/evrone/go-clean-template.svg)](https://github.com/temukan-co/monolith/releases/)
...
# Postgres, RabbitMQ
$ make compose-up
# Run http with migrations
$ make run
```

集成测试（可以在CI中运行）
```sh
# DB, http + migrations, integration tests
